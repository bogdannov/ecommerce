	...
	<td class="forminp">
		<table id="<?php echo esc_attr( $field ); ?>" class="easypack_rates wc_input_table sortable widefat">
			<thead>
				<tr>
					<th class="sort">&nbsp;</th>
					<th><?php esc_html_e( 'Min', 'woocommerce-inpost' ); ?></th>
					<th><?php esc_html_e( 'Max', 'woocommerce-inpost' ); ?></th>
					<th><?php esc_html_e( 'Cost', 'woocommerce-inpost' ); ?></th>
					<th><?php esc_html_e( 'Action', 'woocommerce-inpost' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php $count = 0; ?>
